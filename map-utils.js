...
var getFormattedPlaceName = function (placeObj) {
    ...
    return firstPart + childNodes.filter(
        function (node) {
...
var latLngAreDifferent = function (firstLoc, secondLoc) {
    ...
    var secondLat = parseFloat((secondLoc.lat ||
        secondLoc.latitude).toFixed(6));
    var secondLng = parseFloat((secondLoc.lng ||
        secondLoc.longitude).toFixed(6));
