...
var tilePixelCenter = tileSize / 2;
var pixelsPerLngDegree = tileSize / 360;
var pixelsPerLngRadian = tileSize / (2 * Math.PI);
...
var getDistance = function (posA, posB) {
    ...
    distance = Math.acos(Math.min(partialResult, 1)) * earthRadius;
...
var getRadiusLatLng = function (latLng, radius) {
    ...
    var dist = parseFloat(radius) / (earthRadius * 1000);
